...
<body>
    ...
    <div class="form-group">
        ...
        <select class="un" name="categoria" id="categoria" >
            ...
            @foreach($empresaCategoria as $categoria )
        ...
        <span class="focus-border"></span>
        <input class="un" type="url" name="site" id="site" placeholder="Site">
        <span class="focus-border"></span>
        <input class="un" type="url" name="facebook" id="facebook" placeholder="Facebook">
        <span class="focus-border"></span>
  ...
  <!-- main content area end -->
    <div class="container">
        <div class="row">
            ...
            <div class="parent">
             <div class="box"><img src="{{asset('ondeComer/Empresas/'.$item->foto)}}" style="object-fit:contain; width:200px; height:300px;" alt="Image"/></div>
            <label>Nome:</label>
            <h6>{{$item -> nome}}</h6>
            @foreach ($empresaCategoria as $item1)
               @if($item1->id == $item->categoria)
            ...
            <td>
                <hr>
            <a href="{{ route('edit-empresa',[$item->id]) }}" class="btn btn-primary btn-sm" id="a1">Edit</a>
            <form action="{{ route('delete-empresa',[$item->id]) }}" method="post" id="form1">
                @method('DELETE')
                @csrf
    ...
    <script>
         var saved_markers = <?php echo json_encode($empresa) ?>;
