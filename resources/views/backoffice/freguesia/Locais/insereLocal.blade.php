...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Locais a Visitar</span></li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="form-group">
        <h1>Adicionar Local a Visitar</h1>
    </div>
    <div class="form-group">
        <div class="row">
        <div class="col-5">
        ...
        <select class="un" name="categoria" id="categoria" >
            ...
            @foreach($pontoInteresseCategoria as $categoria )
  ...
  <!-- main content area end -->
    <div class="container">
        <div class="row">
            ...
            <td>
                <hr>
            <a href="{{ route('edit-local',[$item->id]) }}" class="btn btn-primary btn-sm" id="a1">Edit</a>
            <form action="{{ route('delete-local',[$item->id]) }}" method="post" id="form1">
                @method('DELETE')
                @csrf
    ...
    <script>
         var saved_markers = <?php echo json_encode($pontoInteresse) ?>;
