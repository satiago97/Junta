                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Inserir Notícias</span></li>
                            </ul>
                        </div>
                    </div>
...
<div class="form-style-2-heading">Inserir notícia</div>
<form action="{{route('insertNoticia.store')}}" method="post" enctype="multipart/form-data" id="noticiaForm">
@csrf
...
<label for="field1"><span>Decrição <span class="required">*</span></span><textarea class="textArea" name="descricao" form="noticiaForm"required ></textarea></label>
