    ...
    @include('backoffice/sidebar')
        ...
        <div class="main-content">
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><a href="{{ route('servicos-backoffice') }}">Serviços</a></li>
                                <li><span>Editar Serviço</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container" style="margin-top: 20px;">
                <div class="row">
                    <div class="mainText">
<form action="{{ route('update-servico',[$servico->id]) }}" method="post" enctype="multipart/form-data" id="servicoForm">
        <!-- Add CSRF Token -->
        @csrf
        @method('PUT')
    ...
    <div class="form-group">
        <div class="row">
        <div class="col-12">
        <input class="un" type="text" name="titulo" id="titulo" value="{{$servico->titulo}}"  required>
        <span class="focus-border"></span>
        <p>
            <label>Descrição</label>
            <textarea class="TextArea" name="descricao" form="servicoForm" >{{$servico->descricao}}</textarea>
        <span class="focus-border"></span>
        <hr>
