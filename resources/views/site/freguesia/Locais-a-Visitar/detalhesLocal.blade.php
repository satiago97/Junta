...
<div class="container">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{asset('storage/Locais/'.$pontoInteresse->foto)}}" alt="Empresa" width="350" height="350">
                  </div>
                </div>
              </div>
            </div>
    ...
    <script>
        var dados = <?php echo json_encode($pontoInteresse) ?>;
        var saved_markers = [];
