...
<body>
    ...
    @include('backoffice/sidebar')
        ...
        <div class="main-content">
            ...
            <div class="container" style="margin-top: 20px;">
                <div class="row">
                    <div class="mainText">
                    <form action="{{ route('servicos.store') }}" method="post" enctype="multipart/form-data" id="servicoForm">
        <!-- Add CSRF Token -->
        @csrf
    ...
    <div class="form-group">
        ...
        <p>
            ...
            <textarea class="TextArea" name="descricao" form="servicoForm" ></textarea>
        <span class="focus-border"></span>
  ...
  <!-- main content area end -->
    <div class="container" style="margin-top: 100px">
        <div class="row">
            ...
            <div class="parent">
             <div class="box"><img src="{{asset('storage/Servicos/'.$item->foto)}}" style="object-fit:contain; width:200px; height:300px;" alt="Image"/></div>
            <label>Nome:</label>
            <h6>{{$item->titulo}}</h6>
            <td>
                <hr>
            <a href="{{ route('edit-servico',[$item->id]) }}" class="btn btn-primary btn-sm" id="a1">Edit</a>
            <form action="{{ route('delete-servico',[$item->id]) }}" method="post" id="form1">
                @method('DELETE')
                @csrf
