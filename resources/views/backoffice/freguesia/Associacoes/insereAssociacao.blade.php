    ...
    @include('backoffice/sidebar')
        ...
        <div class="main-content">
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Instituições e Associações</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container" style="margin-top: 20px;">
                <div class="row">
                    <div class="mainText">
                    <form action="{{ route('associacao.store') }}" method="post" enctype="multipart/form-data">
        <!-- Add CSRF Token -->
        @csrf
  ...
  <!-- main content area end -->
    <div class="container">
        <div class="row">
            ...
            <div class="parent">
             <div class="box"><img src="{{asset('ondeComer/associacoes/'.$item->foto)}}" style="object-fit:contain; width:200px; height:300px;" alt="Image"/></div>
            <label>Nome:</label>
            <h6>{{$item -> nome}}</h6>
            ...
            <td>
                <hr>
            <a href="{{ route('edit-associacao',[$item->id]) }}" class="btn btn-primary btn-sm" id="a1">Edit</a>
            <form action="{{ route('delete-associacao',[$item->id]) }}" method="post" id="form1">
                @method('DELETE')
                @csrf
    ...
    <script>
         var saved_markers = <?php echo json_encode($associacao) ?>;
