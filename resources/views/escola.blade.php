...
<div class="container">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="https://images.unsplash.com/photo-1557187666-4fd70cf76254?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60" alt="Admin" width="350" height="350">
                  </div>
                </div>
              </div>
            </div>
    ...
    <script>
        var dados = <?php echo json_encode($item) ?>;
        var saved_markers = [];
